...
function start_backend() {
  ...
  cp remote-config.yaml.example "${CONFIG_DIR}/remote-config.yaml"
  cp workload-config.yaml.example "${CONFIG_DIR}/workload-config.yaml"
  cp users.json.example "${CONFIG_DIR}/users.json"
